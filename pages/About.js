...
function About() {
    ...
    return (
        <div id="about" className="min-h-screen flex flex-col bg-[#1b0038]">
            <h1 className="text-md font-bold text-white md: text-4xl ml-20 mb-3 mt-5">What is</h1>
            <h1 className="text-md font-bold text-white md: text-6xl ml-20 mb-8">Zenith?</h1>
            
            <div className="flex items-center justify-evenly">
                {/* text */}
                <div className="md:w-[500px]">
                    <div>
                        <p className="text-xl text-white font-semibold md:text-lg">
