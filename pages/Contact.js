...
function Contact() {
    return (
        <div id="contact" className="min-h-full flex flex-col items-center justify-center">
            <div className="mt-10 sm:mt-0">
                <div className="mb-8">
                    <h3 className="text-3xl font-bold leading-6 text-[#300E54] ">Contact Us</h3>
                </div>
            </div>
            ...
            <div>
                {/* All right reserved */}
                <div className="w-screen bg-[#030035] text-white text-center">
