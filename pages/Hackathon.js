  ...
  return (
    <div className="flex flex-col bg-[#F8F0E3]">
      ...
      <div className="mt-32">
        ...
        {/* Themes */}
        <div>
          <h1 className="text-6xl text-center font-semibold underline mb-5 ">
            Theme
          </h1>

          <div className="grid grid-cols-2 items-center bg-red-500 lg:mt-2 lg:p-5">
            {/* details */}
          ...
          <div className="grid grid-cols-2 items-center bg-blue-500 lg:mt-2 lg:p-5">
            {/* Illustration */}
          ...
          <div className="grid grid-cols-2 items-center bg-green-500 lg:mt-2 lg:p-5">
            {/* details */}
          ...
          <div className="grid grid-cols-2 items-center bg-yellow-500 lg:mt-2 lg:p-5">
            {/* Illustration */}
